        ...
        while (1):
            try:
                ...
                if 'eegPower' in self.json_data:
                    ...
                    self.data_to_write = []
                    self.data_to_write.append(str(self.json_data[u'eSense'][u'attention']))
                    ...
                    for items in mindstate:
                        ...
                        m = int(items)
                        if m < 50:
                            mc.setBlock(pos.x, pos.y-1, pos.z, 42)#iron block
                        elif m > 50:
                            mc.setBlock(pos.x, pos.y-1, pos.z, 41)#gold block
